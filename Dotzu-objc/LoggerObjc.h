...
#define LogVerbose(message, ...) [LoggerObjc verbose: [NSString stringWithFormat: message, ##__VA_ARGS__] filePath:[NSString stringWithUTF8String:__FILE__] function:[NSString stringWithUTF8String:__FUNCTION__] line:__LINE__]
...
#define LogError(message, ...) [LoggerObjc error: [NSString stringWithFormat: message, ##__VA_ARGS__] filePath:[NSString stringWithUTF8String:__FILE__] function:[NSString stringWithUTF8String:__FUNCTION__] line:__LINE__]
